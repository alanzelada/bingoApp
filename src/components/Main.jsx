...
const Main = () => {
    ...
    return (
        <View style={[styles.container, { height }]}>
            ...
            <View style={styles.containerSvgSocialMedia}>
                <Text style={{ color: '#FFFFFE', fontFamily: 'PoppinsMedium', fontSize: 14}}>Development</Text>
                <View style={styles.svgSocialMedia}>
                <Svg
                        width={30}
                        height={30}
                        viewBox="0 0 310 310"
...
const styles = StyleSheet.create({
    ...
    svgSocialMedia:{
        flexDirection: 'row',
        gap: 34,
        zIndex: 1 // Añadí zIndex para asegurar que esté en frente
    }
})